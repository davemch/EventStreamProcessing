...
public class AggregateRefuseEvent extends AggregateEvent {
     ...
     * Aggregator
     */
    public static class AggregateRefuseEvents extends ProcessWindowFunction<Refuse, AggregateRefuseEvent, Tuple2<String, Date>, TimeWindow> {
        @Override
        public void process(Tuple2<String, Date> key, Context context, Iterable<Refuse> events, Collector<AggregateRefuseEvent> collector) throws Exception {
            int amount = 0;
